...
- **详细更新日志**：查看 [CHANGELOG.md](CHANGELOG.md) 文件
- **预览主题**：[羽翼博客](https://www.886a.top)
## 版本更新日志
...
### v3.2.0 (2026-02-26)
   ...
   **白屏问题、结构化数据与主题设置修复**
   > - 修复白屏问题，添加完善的容错处理
   > - 修复了Google Rich Results测试中发现的结构化数据问题
   > - 修复了面包屑导航中缺少item字段的问题
   > - 修复了后台设置中"首页显示链接"、"显示最新的'轻语'"、"侧边栏显示"等选项无法选中的问题


### v3.1.2 (2026-02-26)

   **文章排版、验证码与SEO优化**
   > - 优化验证码代码结构，解决潜在的错误调用问题
   > - 优化文章排版样式，设置响应式排版设计，适配不同屏幕尺寸
   > - 优化SEO配置，添加完整的Schema.org结构化数据支持（前往测试>>[Google Rich Results测试](https://search.google.com/test/rich-results)）

### v3.1.1 (2026-02-25)

   **侧边栏样式与功能优化**
   > - 新增随机文章模块，展示随机文章列表
   > - 新增统计模块，展示网站文章数量、评论数量、运行时间等信息
