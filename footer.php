...
<script src="//<?php if ($this->options->cjCDN == 'cf'): ?>cdnjs.cloudflare.com/ajax/libs/highlight.js/11.12.0/highlight.min.js<?php else: ?>cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.12.0/build/highlight.min.js<?php endif; ?>"></script>
<script src="//<?php if ($this->options->cjCDN == 'cf'): ?>cdnjs.cloudflare.com/ajax/libs/highlight.js/11.12.0/languages/powershell.min.js<?php else: ?>cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.12.0/build/languages/powershell.min.js<?php endif; ?>"></script>
